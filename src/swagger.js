  ...
  paths: {
    "/users": {
      post: {
        ...
        responses: {
          ...
          401: {
            description: "Erro de validação (verifique se os campos necessários foram fornecidos)."
          }
        }
      }
    },
          ...
          content: {
            'application/json': {
              schema: {
                ...
                required: ['emp_razaosoci', 'emp_cnpj', 'emp_email', 'emp_senha'],
              },
            },
          },
        },
    ...
    '/empresa': {
      get: {
        ...
        description: 'Retorna a lista de todas as empresas cadastradas no sistema',
        tags: ['Empresas'], 
        responses: {
          200: {
